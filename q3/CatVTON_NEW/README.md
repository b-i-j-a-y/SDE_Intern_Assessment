# Q3 - Virtual Try-On using CatVTON

## Overview

Implemented a diffusion-based virtual try-on pipeline using CatVTON.
...
Processing:
- DensePose human understanding
- Clothing mask generation
- CatVTON diffusion-based garment transfer
...
The model was adapted for Apple Silicon:

- MPS backend support
- CPU DensePose execution
- Memory-efficient attention for MPS devices

## Run

```bash
streamlit run app_streamlit.py# [ICLR 25]🐈 CatVTON: Concatenation Is All You Need for Virtual Try-On with Diffusion Models
